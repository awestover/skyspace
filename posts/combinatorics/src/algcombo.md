...
\includesvg[width=0.5\linewidth]{images/ink_img001.svg}
  
\end{proof}

\newpage
\section{bijection of trees}
...
\begin{figure}[h]
\centering
\includesvg[width=0.5\linewidth]{images/ink_img004.svg}
\end{figure}
...
\begin{figure}[h]
\centering
\includesvg[width=0.5\linewidth]{images/ink_img006.svg}
\end{figure}


\newpage
\section{modmaj, modinv}
...
\includesvg[width=0.5\linewidth]{images/ink_img002.svg}

\newpage
\section{exceedences, weak exceedences}
\begin{proposition}
...
\includesvg[width=0.5\linewidth]{images/ink_img003.svg}
\end{proof}

\newpage
\section{coloring with skips}
...
\begin{proof}
  ...
  \begin{figure}[h]
    \centering
\includesvg[width=0.5\linewidth]{images/ink_img009.svg}
  \end{figure}
...
\begin{figure}[h]
  \centering
\includesvg[width=0.5\linewidth]{images/ink_img007.svg}
\includesvg[width=0.5\linewidth]{images/ink_img008.svg}
\end{figure}

\newpage
\section{bonus: boolean lattice}
