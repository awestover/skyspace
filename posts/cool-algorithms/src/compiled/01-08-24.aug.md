...
"In the Point Line Cover problem, we are given a set of n points in the plane
...
So let's start by running Crow Lemma. 
If crown lemma outputs a huge matching we instantly reject. 
Else, we get a crown decomposition.
